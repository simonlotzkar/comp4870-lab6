...
public class HttpWebAPI
{
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students/count-by-school")] HttpRequestData req)
    {
        ...
        var response = req.CreateResponse(HttpStatusCode.OK);
        response.Headers.Add("Content-Type", "application/json");
        response.WriteStringAsync(JsonConvert.SerializeObject(studentCounts));
    ...
    (
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "students/id/{id}")] HttpRequestData req,
        int id
    )
    {
    ...
    (
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "students/id/{id}")] HttpRequestData req,
        int id
    )
    {
    ...
    (
      [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "students/id/{id}")] HttpRequestData req,
      int id
    )
    {
